...
export default function Footer() {
  return (
    <footer className="relative bg-[#fffde7] text-black text-center text-lg italic overflow-hidden mt-10">
      ...
      {/* Footer Content */}
      <p className={`mt-2 mb-2 ${playfairDisplay.className} text-center mx-auto flex items-center justify-center gap-2`}>
